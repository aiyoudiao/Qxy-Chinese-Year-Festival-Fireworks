...
const shellTypesTitle = {
  Random: "随机",
  Crackle: "裂纹-再次分裂",
  Crossette: "裂纹之二次回归",
  Crysanthemum: "常规礼炮",
  "Falling Leaves": "黄金粉-分裂",
  Floral: "霓虹绚烂",
  Ghost: "黄金粉-二次绚烂",
  "Horse Tail": "单筒烟花",
  Palm: "霓虹粉饰",
...
function init() {
  ...
  shellNames.forEach(
    (opt) =>
      (options += `<option value="${opt}">${
        shellTypesTitle[opt] || opt
      }</option>`)
  );
  appNodes.shellType.innerHTML = options;
  // shell size
  options = "";
  ["3立方米", "4立方米", "6立方米", "8立方米", "12立方米", "16立方米"].forEach(
  ...
  setOptionsForSelect(appNodes.quality, [
    ...
    { label: "普通质量", value: QUALITY_NORMAL },
    { label: "高质量", value: QUALITY_HIGH },
  ]);

  setOptionsForSelect(appNodes.skyLighting, [
    { label: "不亮", value: SKY_LIGHT_NONE },
